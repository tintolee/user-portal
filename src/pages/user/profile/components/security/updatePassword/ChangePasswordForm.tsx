...
const ChangePasswordForm = ({ handleFalse, state }: Props) => {
  ...
  return (
    <Dialog2 isOpen={state} handleClose={handleFalse}>
      ...
      <Form<InitialValuesI>
        ...
        <Box className="ss-space-y-3">
          ...
          <Button onClick={handleFalse} label="Cancel" variant="tertiary" isBlock />
        </Box>
      </Form>
    </Dialog2>
  );
