...
const PaymentTypeBox = ({ svg, description, title, name, value }: PaymentTypeBoxProps) => {
  ...
  return (
    <label
      ...
      <Box className="ss-w-12 ss-bg-neutral-200 ss-rounded-full ss-h-12 ss-flex ss-items-center ss-justify-center">
